...
if(!(name.match(valid_name_regex)) || !(age.match(valid_age_regex))|| (city == "")){
    ...
    if(!(name.match(valid_name_regex))){
        ...
        document.getElementById("name_error").style.borderColor = "red";
    ...
    if(!(age.match(valid_age_regex))){
        ...
        document.getElementById("age_error").style.borderColor = "red";
    ...
    if(city == ""){
        ...
        document.getElementById("city_error").style.borderColor = "red";
